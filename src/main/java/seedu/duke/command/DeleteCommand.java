...
public class DeleteCommand extends Command {
    private static final String DELETE_COMPLETE_MESSAGE = "This item has been removed from the list."; //to be added to UI part later
    ...
    public DeleteCommand(String name, ItemContainer list) {
        this.selectedItem = list.getItem(name); // will add exception handling (cannot find item) once the the getItem() method adds exception
    }
