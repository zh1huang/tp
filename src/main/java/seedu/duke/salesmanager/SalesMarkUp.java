...
public class SalesMarkUp {
    ...
    private final int TWO_DECIMAL_POINT = 2;
    private final int INTEGER_TWENTY = 20;
    private final int INTEGER_SIX = 6;
    private final int INTEGER_VALUE_ONE = 1;
    private final int INTEGER_ONE_HUNDRED = 100;
    private final BigDecimal ONE_HUNDRED = new BigDecimal(INTEGER_ONE_HUNDRED);
