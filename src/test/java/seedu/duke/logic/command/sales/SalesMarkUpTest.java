...
class SalesMarkUpTest {
    ...
    @Test
    public void getItemToMarkUpInfo_itemInShelf_executesNormally() throws ShelfNotExistModelException {
    ...
    // todo
    @Test
    public void getSelectedItemMarkUpInfo_itemInShelf_executesNormally() throws ShelfNotExistModelException {
    ...
    @Test
    public void getUserRequestMarkUpInfo_itemInShelf_executesNormally() throws ShelfNotExistModelException {
        SalesMarkUp salesMarkUpTest = new SalesMarkUp(TEST_SHELF_NAME, 1, "86.05");
    ...
    @Test
    public void getEstimatedMarkUpInfo_itemInShelf_executesNormally() throws ShelfNotExistModelException {
