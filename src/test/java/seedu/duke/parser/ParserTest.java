...
public class ParserTest {
    ...
    /**
     @Test public void parse_addCommandInvalidArgs_throwsIllegalFormatException() {
     ...
     @Test public void parse_addCommandValidArgs_returnsAddCommand() throws ItemNotExistException,
    ...
    /**
     @Test public void parse_deleteCommandInvalidArgs_throwsIllegalFormatException() {
     final String[] inputs = {
     "delete ",
     "delete p/37",
     "delete q/37"
     ...
     @Test public void parse_deleteCommandValidArgs_returnsDeleteCommand() throws IllegalFormatException,
    ...
    /**
     @Test public void parse_listCommandInvalidArgs_throwsIllegalFormatException() {
     final String[] inputs = {
     "list p/223",
     "list p/dme",
     "list r/idmwk "
     ...
     @Test public void parse_listCommandValidArgs_returnsListCommand() throws IllegalFormatException,
     ItemNotExistException, NoPropertyFoundException {
    ...
    /**
     @Test public void parse_getCommandInvalidArgs_throwsIllegalFormatException() {
     final String[] inputs = {
     "get ",
     "get p/quantity"
     };
     ...
     @Test public void parse_getCommandValidArgs_returnsGetCommand() throws IllegalFormatException,
     ItemNotExistException, NoPropertyFoundException {
